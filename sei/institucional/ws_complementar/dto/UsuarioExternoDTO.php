...
class UsuarioExternoDTO extends InfraDTO {
	...
	public function montar() {
		...
		$this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR,'TelefoneContato','telefone','contato');		
		...
		$this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR,'SiglaEstadoContato','sigla_estado','contato');
